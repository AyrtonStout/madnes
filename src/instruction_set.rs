...
static INSTRUCTIONS: &'static [InstructionType] = &[
    ...
    InstructionType { name: "ORA", num_bytes: 2, num_cycles: 6, addressing_mode: AddressingMode::AbsoluteX }, // 1 (Indirect, X)
    ...
    InstructionType { name: "EOR", num_bytes: 3, num_cycles: 4/* * */, addressing_mode: AddressingMode::AbsoluteX }, // 59 (Absolute, X)
    ...
    InstructionType { name: "STX", num_bytes: 2, num_cycles: 4, addressing_mode: AddressingMode::ZeroPageAbsoluteX }, // 96 (Zero Page, X)
